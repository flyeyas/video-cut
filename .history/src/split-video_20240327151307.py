...
def split_video_into_scenes(video_path, output_path, threshold=2.0):
...
def split_video(folder_path, output_path):
    ...
    for file_name in file_list:
        ...
        ret = split_video_into_scenes(file_path)
        print(file_path, 'end......，ret %s' % )


if __name__ == "__main__":
    folder_path = "/Users/flyeyas/Downloads/治愈书籍带货/动漫素材/动漫"
    output_path = "~/Downloads/治愈书籍带货/动漫素材镜头分割"
