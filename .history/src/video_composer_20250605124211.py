...
# Lazy import for moviepy to avoid import issues
def _import_moviepy():
    """Lazy import of moviepy modules to handle import issues."""
    try:
        from moviepy.editor import VideoFileClip, AudioFileClip, concatenate_videoclips
        return VideoFileClip, AudioFileClip, concatenate_videoclips
    except ImportError as e:
        logger.error(f"Failed to import moviepy: {e}")
        logger.error("Please install moviepy: pip install moviepy>=2.0.0")
        raise ImportError("moviepy is required but not properly installed") from e
...
class VideoComposer:
    ...
    def cut_video(self, video_path: str, start_time: float, duration: float, output_path: str) -> str:
        ...
        try:
            ...
            try:
                VideoFileClip, _, _ = _import_moviepy()
    ...
    def compose_video(self, 
        ...
        try:
            ...
            VideoFileClip, AudioFileClip, concatenate_videoclips = _import_moviepy()
